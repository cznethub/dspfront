...
export const repoMetadata: { [key: string]: IRepository } = {
  [EnumRepositoryKeys.hydroshare]: {
    ...
    name: 'HydroShare',
    logoSrc: '/src/assets/img/hydroshare.png',
  ...
  [EnumRepositoryKeys.earthchem]: {
    ...
    logoSrc: '/src/assets/img/earthchem.png',
  ...
  [EnumRepositoryKeys.zenodo]: {
    ...
    name: 'Zenodo',
    logoSrc: '/src/assets/img/zenodo.png',
  ...
  [EnumRepositoryKeys.sesar]: {
    ...
    logoSrc: '/src/assets/img/sesar.png',
  ...
  [EnumRepositoryKeys.openTopography]: {
    ...
    name: 'OpenTopography',
    logoSrc: '/src/assets/img/openTopography.png',
  ...
  [EnumRepositoryKeys.dryad]: {
    ...
    name: 'Dryad',
    logoSrc: '/src/assets/img/dryad.png',
  ...
  [EnumRepositoryKeys.pangaea]: {
    ...
    name: 'Pangaea',
    logoSrc: '/src/assets/img/pangaea.png',
  ...
  [EnumRepositoryKeys.edi]: {
    ...
    logoSrc: '/src/assets/img/edi.png',
  ...
  [EnumRepositoryKeys.scienceBase]: {
    ...
    logoSrc: '/src/assets/img/scienceBase.png',
  ...
  [EnumRepositoryKeys.osf]: {
    ...
    name: 'OSF',
    logoSrc: '/src/assets/img/osf.png',
  ...
  [EnumRepositoryKeys.geo]: {
    ...
    name: 'GEO',
    logoSrc: '/src/assets/img/geo.png',
  ...
  [EnumRepositoryKeys.bioSample]: {
    ...
    name: 'BioSample',
    logoSrc: '/src/assets/img/bioSample.png',
  ...
  [EnumRepositoryKeys.sra]: {
    ...
    logoSrc: '/src/assets/img/sra.png',
  ...
  [EnumRepositoryKeys.itrdb]: {
    ...
    logoSrc: '/src/assets/img/itrdb.png',
  ...
  [EnumRepositoryKeys.gitHub]: {
    ...
    name: 'GitHub',
    logoSrc: '/src/assets/img/github.png',
  ...
  [EnumRepositoryKeys.ameriFlux]: {
    ...
    name: 'AmeriFlux',
    logoSrc: '/src/assets/img/ameriflux.png',
  ...
  [EnumRepositoryKeys.hydrolearn]: {
    ...
    name: 'HydroLearn',
    logoSrc: '/src/assets/img/hydrolearn.png',
