...
export const repoMetadata: { [key: string]: IRepository } = {
  [EnumRepositoryKeys.hydroshare]: {
    ...
    identifierUrlPattern: new RegExp(`(?<=hydroshare.org/resource/).[a-z0-9]*`)
  },
  [EnumRepositoryKeys.earthchem]: {
    ...
    identifierUrlPattern: new RegExp(`(?<=earthchem.org/my/my_view.php?id=).[a-z0-9]*`)
  },
  [EnumRepositoryKeys.zenodo]: {
    ...
    identifierUrlPattern: new RegExp(`(?<=zenodo.org/deposit/).[a-z0-9]*`)
  },
