      ...
      <section>
        ...
        <div class="has-space-bottom-2x">
          <div class="repositories">
            <v-card v-for="repo of repoMetadata" :key="repo.key" @click.native="submitTo(repo)">
              <div class="" style="height: 10rem; padding: 2rem;">
                <img :src="repo.logoSrc" :alt="repo.name" class="">
              </div>
              <div>
...
<style lang="scss" scoped>
  ...
  .repositories {
    ...
    .v-card-media {
      // background: linear-gradient(135deg, #f1f3f5 0%, var(--second-color-here) 100%);
