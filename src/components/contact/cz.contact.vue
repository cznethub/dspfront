<template>
  <div class="cz-contact">
    <h1 class="md-display-1">How to Contact Us</h1>
    <hr>
    ...
    <div class="md-headline">Join Us in the CZNet Slack Workspace</div>
    <p>
    ...
    <div class="md-headline">Contact Us Directly via Email</div>
    <p>
