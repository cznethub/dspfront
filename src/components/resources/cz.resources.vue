<template>
  <div class="cz-resources">
    <v-container
      class="text-center mb-2 banner d-flex flex-column align-center py-12"
    >
      ...
      <v-btn color="primary" to="/resources/quick-start-guide"
        >Quick Start Guide</v-btn
      >
    </v-container>
    <v-container
      class="has-bg-light-gray text-center mb-2 banner d-flex flex-column align-center py-12"
    >
      ...
      <v-btn color="primary" to="/resources/recommendations"
        >Help Me Decide</v-btn
      >
    </v-container>
    ...
    <v-container class="mb-4">
      ...
      <div class="d-flex flex-column align-center pt-8">
        ...
        <p class="text--secondary text-subtitle-1 text-center">
          Access best practices, recommendations, suggested formats and
          repository recommendations for the data types listed below.
        </p>
      </div>
      ...
      <div class="mb-2 d-flex justify-center">
        <div id="data-templates" class="d-inline-flex flex-column">
          <div
            v-for="(tmp, index) of dataTemplates"
            :key="index"
          ...
          >
            ...
            <div class="text-center text-md-left">
              <div class="text-h6">
                <a :href="tmp.url" target="_blank">{{ tmp.title }}</a>
              </div>
    ...
    <v-container class="my-4 d-flex flex-column align-center py-8 text-center">
      ...
      <ul class="text-left">
        <li class="text--secondary text-subtitle-1">
          HydroShare API:
          <a
        ...
        <li class="text--secondary text-subtitle-1">
          Zenodo API:
          <a href="https://developers.zenodo.org/" target="_blank"
            >https://developers.zenodo.org/</a
          >
        </li>
      </ul>
    </v-container>
