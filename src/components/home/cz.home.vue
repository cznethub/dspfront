<template>
  <div class="cz-home">
    <section class="banner has-text-centered"
      ...
      <h2 class="md-display-1 has-text-white">Data Submission Portal</h2>
      <h2 class="md-headline has-text-white" style="margin-top: 4rem;">Ready to Submit Data?</h2>
    ...
    <section>
      ...
      <div class="md-layout repos md-alignment-center-center">
        <div class="md-layout-item md-xsmall-size-50"><img :src="require('@/assets/img/placeholder.png')" alt=""></div>
        <div class="md-layout-item md-xsmall-size-50"><img :src="require('@/assets/img/placeholder.png')" alt=""></div>
        <div class="md-layout-item md-xsmall-size-50"><img :src="require('@/assets/img/placeholder.png')" alt=""></div>
        <div class="md-layout-item md-xsmall-size-50"><img :src="require('@/assets/img/placeholder.png')" alt=""></div>
        <div class="md-layout-item md-xsmall-size-50"><img :src="require('@/assets/img/placeholder.png')" alt=""></div>
