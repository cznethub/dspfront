<template>
  <v-container class="cz-quick-start-guide">
    <div class="text-h4">Data Submission Portal Quickstart Guide</div>
    ...
    <ul class="text-body-1">
      <li><strong>EarthChem: </strong>EarthChem is a repository that specializes in publishing data derived from physical samples.</li>
      <li><strong>HydroShare: </strong>HydroShare is a repository that specializes in storing data related to water science. HydroShare is file agnostic and can support any file type.</li>
      <li><strong>Zenodo: </strong>Zenodo is a general-purpose repository that can be used for sharing data or other content that might not fit well in other repositories.</li>
    </ul>

    <div class="text-h6 mb-3 mt-6">Registering Datasets That are Not in a Supported Repository</div>
    <p class="text-body-1">
